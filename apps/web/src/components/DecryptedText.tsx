/**
 * Vendored from the React Bits registry (DecryptedText-TS-TW), with two local
 * changes, both marked "hippo:" below.
 *
...
export default function DecryptedText({
  ...
  const triggerDecrypt = useCallback(() => {
    // hippo: honour the system setting. Someone who has asked for less motion
    // should get the headline, not a scramble. Guarded because jsdom and older
    // browsers have no matchMedia.
    if (
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: vendored as published. Over-specified deps only mean the effect re-runs when those props change, which is correct; trimming them would be editing someone else's logic to satisfy a linter.
  useEffect(() => {
  ...
  return (
    <motion.span
      ...
      {...props}
    >
      {/* hippo: the real text, never the scrambled one. A screen reader must
          hear the headline, not the animation. */}
