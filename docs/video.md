# Demo video script, about 2 minutes 40

The target was two minutes. The revocation pause cannot be cut (see below) and
the correction beat earns its ten seconds, so this runs long; if it must be two
minutes, cut "it follows you" first.
...
**1:30 — you own it, 30s.** `/connect` in the chat, open the link, connect the
...
**2:00 — you can take it back, 30s.** Use the "Revoke hippo's access" button on
